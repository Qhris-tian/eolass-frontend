<template>
  <div class="md:p-4 md:ml-[7rem] p-2">
        ...
        <form class="md:w-[500px]" @submit.prevent="search">
          <div class="flex items-center bg-purple-light border border-purple/50 rounded-full shadow-sm">
            ...
            <div class="w-full rounded-full">
              <input v-model="needle" type="text" aria-label="Search catalog" placeholder="Search catalog"
                autocomplete="off"
    ...
    <CreateOrderModalVue v-show="showCreateOrderModal" :product="selectedProduct" @close-modal="closeOrderModal" />
  </div>
</template>
